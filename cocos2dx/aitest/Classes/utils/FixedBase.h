...
// TODO: 三角函数定点化;
inline Fixed FixedSin(const Fixed &f)
{
	return ::sin((double)f);
}
inline Fixed FixedASin(const Fixed &f)
{
	return ::asin((double)f);
}
inline Fixed FixedCos(const Fixed &f)
{
	return ::cos((double)f);
}
inline Fixed FixedACos(const Fixed &f)
{
	return ::acos((double)f);
}
inline Fixed FixedTan(const Fixed &f)
{
	return ::tan((double)f);
}
inline Fixed FixedATan(const Fixed &f)
{
	return ::atan((double)f);
}
inline Fixed FixedExp(const Fixed &f)
{
	return ::exp((double)f);
}
