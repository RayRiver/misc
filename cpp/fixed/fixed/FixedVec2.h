...
public:
	...
	FixedVec2();
	explicit FixedVec2(const Fixed &_x, const Fixed &_y);
	explicit FixedVec2(int _x, int _y);
	explicit FixedVec2(float _x, float _y);
	explicit FixedVec2(double _x, double _y);
